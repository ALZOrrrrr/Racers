...
public class RacersTimeTest {
    ...
    private String expectedStandart = "1.Sebastian Vettel      | FERRARI                       | 01:04.415\n" +
            "2.Daniel Ricciardo      | RED BULL RACING TAG HEUER     | 01:12.13\n" +
            ...
            "14.Esteban Ocon         | FORCE INDIA MERCEDES          | 01:13.28\n" +
            "15.Nico Hulkenberg      | RENAULT                       | 01:13.65\n" +
            "------------------------------------------------------------------------\n" +
    ...
    public void standartTest() throws Exception{
        String actual = racersTime.calculate();
