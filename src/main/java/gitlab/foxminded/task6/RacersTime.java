    ...
    public class RacersTime {
        ...
        private void validate(String a, String b, String c) {
            if (a == null || b == null || c == null)
                throw new IllegalArgumentException("null transferred");
        }
        ...
        public List<Racer> getRacers(String abbreviations, String startTime, String endTime){
            validate(abbreviations,startTime,endTime);
            try {
